...
{
    public class SLangUnexpectedToken : SyntaxError
    {
        private string _message;
        private string _expected;
        public SLangUnexpectedToken(string _file_name, string expected, SourceContext _source_context, syntax_tree_node _node)
