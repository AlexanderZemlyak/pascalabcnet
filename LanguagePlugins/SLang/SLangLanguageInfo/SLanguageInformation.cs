...
namespace Languages.SLang.Frontend.Data
{
    internal class SLangLanguageInformation : BaseLanguageInformation
    {
        public override BaseKeywords KeywordsStorage { get; } = new SLangParser.SLangKeywords();
